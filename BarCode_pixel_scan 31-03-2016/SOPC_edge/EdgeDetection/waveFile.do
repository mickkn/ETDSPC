...
add wave -noupdate -radix unsigned /edge_detection_file_tb/ast_source_data
...
WaveRestoreCursors {{Cursor 1} {719615000 ps} 0}
...
update
WaveRestoreZoom {719322320 ps} {721072510 ps}
